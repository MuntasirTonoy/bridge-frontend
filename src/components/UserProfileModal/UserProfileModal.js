      ...
      <div className="relative bg-bg-white rounded-[24px] w-[340px] overflow-hidden shadow-[0_24px_60px_rgba(0,0,0,0.18),0_0_0_1px_rgba(255,255,255,0.1)] animate-slide-up flex flex-col items-center pb-7 max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        ...
        <div className="flex items-center gap-0 bg-bg-primary rounded-[14px] p-3 px-2 w-[calc(100%-40px)] mb-4">
          <div className="flex-1 flex flex-col items-center gap-0.5">
            <span className="text-[0.88rem] font-bold text-text-primary">Active</span>
            <span className="text-[0.66rem] text-text-muted font-medium tracking-tight">Status</span>
          </div>
          <div className="w-[1px] h-7 bg-border-medium shrink-0" />
          <div className="flex-1 flex flex-col items-center gap-0.5">
            <span className="text-[0.88rem] font-bold text-text-primary">{user.joinedDate || 'Recently'}</span>
        ...
        {/* Edit profile button */}
        <button 
          className="flex items-center gap-[7px] py-2.5 px-7 bg-accent-primary text-white rounded-xl text-[0.85rem] font-semibold cursor-pointer transition-all shadow-[0_4px_14px_rgba(61,90,115,0.28)] hover:bg-accent-dark hover:-translate-y-0.5" 
